        ...
        <div className="ml-auto hidden lg:flex items-center gap-6">
          ...
          {user && (
            <div className="dropdown dropdown-end">
              <label tabIndex={0} className="btn btn-circle avatar bg-linear-to-br from-primary to-secondary text-white shadow">
                {user.photo ? (
              ...
              >
                ...
                <li>
                  <button
                    onClick={handleLogout}
                    className="text-error hover:bg-error/10 px-3 py-2 rounded-lg w-full text-left"
                  >
                    Logout
                  </button>
                </li>
